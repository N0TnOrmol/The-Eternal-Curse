...
public class MeleeWeapon : MonoBehaviour
{
    ...
    void Start()
    {
        animator = GetComponent<Animator>();  // Get the Animator component (if using animations)
    }
    ...
    private IEnumerator SwingWeapon()
    {
        ...
        // Play the swing animation if you have one
        if (animator != null)
        {
        ...
        foreach (Collider enemy in hitEnemies)
        {
            ...
            if (enemy.CompareTag("Enemy"))
            {
                ...
                enemy.GetComponent<DmgHp>().TakeDamage(damage);
            }
        }
